...
namespace MutliMonitorImageMerger
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            imagesWithMonitor.Add(Screen.PrimaryScreen.DeviceName, Image.FromFile(@"C:\Users\Kevin\Pictures\WallpaperChanger\wallhaven-93423.jpg"));
            ...
            string finalImage = merger.MergeImagesAccordingToMonitors(imagesWithMonitor, Merger.SCALEMODE.OVERSCALEDANDCENTERED);
